...
¡Hola! 👋 Este repositorio contiene la solución completa, tanto práctica como teórica, de los **6 ejercicios finales del Capítulo 1 (Página 37)** del libro *Flex & Bison*.

Aquí encontrarás el código fuente implementado para los ejercicios de programación, junto con las explicaciones teóricas y una guía en PDF lista para consultar.

---

## 📂 Contenido del Repositorio

| Ejercicio | Tipo | Archivos | Descripción rápida |
| :--- | :--- | :--- | :--- |
| **1. Líneas de comentarios** | Teórico / Gramática | *(Explicado abajo y en PDF)* | Análisis de por qué una línea con solo `// comentario` da error de sintaxis y cómo solucionarlo en el parser de Bison. |
| **2. Calculadora Hex & Dec** | Práctico (Flex + Bison) | `ejercicio_2_hex.l`<br>`ejercicio_2_hex.y` | Calculadora que reconoce números en hexadecimal (`0x1A`) y decimal (`26`), imprimiendo el resultado en ambos formatos. |
| **3. Operadores a nivel de bits** | Práctico (Flex + Bison) | `ejercicio_3_bitwise.l`<br>`ejercicio_3_bitwise.y` | Agrega `&` (AND), `\|` (OR), `^` (XOR) y `~` (NOT), resolviendo la ambigüedad del símbolo `\|` (OR binario vs. valor absoluto unario). |
| **4. Escáner manual vs. Flex** | Teórico / Comparativa | *(Explicado abajo y en PDF)* | Comparación técnica entre el lexer manual en C y la versión generada con Flex. |
| **5. Lenguajes no aptos para Flex** | Teórico / Diseño | *(Explicado abajo y en PDF)* | Casos donde las expresiones regulares de Flex se quedan cortas (Python, C++, Fortran, etc.). |
...
## 📝 Resumen de Respuestas Teóricas
...
## 🛠️ ¿Cómo compilar y probar los ejercicios prácticos?
...
./calc_hex
```
*Prueba ingresando:* `0x10 + 15` o `(0xFF - 5) * 2` &rarr; Te devolverá el resultado tanto en decimal como en hexadecimal.
...
./calc_bitwise
```
*Prueba ingresando:* `0xFF & 0x0F` o `5 ^ 3` o `~0` &rarr; Te devolverá el resultado en decimal, hexadecimal y binario formateado.
...
## 📄 Documento PDF Detallado

Para una lectura más cómoda y con todos los diagramas y código formateado, puedes consultar el documento PDF incluido en este repositorio:

👉 **[Solucion_Ejercicios_Flex_Bison_Pag_37.pdf](Solucion_Ejercicios_Flex_Bison_Pag_37.pdf)**

---
Repositorio educativo para el curso de Compiladores y Lenguajes de Programación.
